...
|---------|-----------------|
| `.opencode/rules/ui-components.md` | Travail sur `.vue`, CSS, design system, composants UI, Storybook, conventions frontend (Pinia, i18n, Tailwind) |
| `.opencode/rules/conventions.md` | Conventions code Python/TypeScript générales, règles Git, format kanban Markdown |
...
- *"ajoute un composant Select"* → charger `ui-components.md`
- *"implémente la US 7-32"* → charger `workflow.md` + `ui-components.md` (si frontend) ou `workflow.md` + `conventions.md` (si backend)
